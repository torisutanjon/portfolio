...
const Contact = () => {
  ...
  return (
    <div className="relative w-full flex flex-col items-center justify-center mt-24">
      <p className="text-2xl font-bold md:text-3xl">
        How to <span className="text-orange">reach</span> me ?
      </p>
      <div className="mt-4 w-4/5 border-[1px] flex flex-col items-center border-lightPrimary dark:border-darkPrimary md:mt-12 md:w-3/5">
        <input
          type="text"
        ...
        <textarea
          id=""
          className="mt-4 h-24 w-4/5 p-2 text-sm bg-transparent border-[1px] border-lightPrimary dark:border-darkPrimary outline md:mt-8 md:h-36"
          name="message"
